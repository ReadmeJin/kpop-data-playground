...
export default function SpotifyGraph({ }: Props) {
    ...
    return (
        <GraphControlsLayout
            AsideComponent={() => (
                <>
                    <div className=''>
                        <Radio.Group name="spotify" onChange={setRadioVal} value={radioVal}>
                            <Radio.Button id="spotify-subs" value="subs">Subs</Radio.Button>
                            <Radio.Button id="spotify-views" value="views">Views</Radio.Button>
                        </Radio.Group>
