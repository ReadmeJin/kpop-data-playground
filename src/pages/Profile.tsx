...
const Profile = ({ }: ProfileProps) => {
	...
	return (
		<div className="artist-profile relative w-full flex min-h-screen">
			<div className='artist-container items-center px-4 w-full md:max-w-[70vw] mx-auto'>
				<div className='artist-info'>
					<div className='artist-title__container relative isolate'>
						<h1 className='artist-info__title my-[20vh] md:my-[30vh] text-[clamp(60px,12vw,12vw)] leading-[clamp(60px,12vw,12vw)] whitespace-pre-wrap overflow-hidden bg-blend-difference'>{artistsData.blackpink.title}</h1>
						<img
